...
<head>
    ...
    <title>seaofblue -restaurance</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="admin/dangky" method="POST">
                            ...
                            <fieldset>
                                ...
                                <button type="submit" class="btn btn-lg btn-success btn-block">dang ky</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
