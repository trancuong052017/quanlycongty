...
<div class="wrapper">
    ...
    <div class='alert alert-success'>
     ...
     <form action="admin/thucongtrinh/sua/{{$thucongtrinh->id}}" method="POST"enctype="multipart/form-data">
    ...
    {{$ct->ten}}
           ...
           @endforeach 
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
<input type="text"  name="tien"value="{{number_format($thucongtrinh->tien)}}" _autocheck='true' class = 'format_number'>
                     </div>
                <div class="clear"></div>
                 </div>
                ...
                <div class="formRow">
                 ...
                 <div class="formRow">
                    <label for="param_qty" class="formLeft">ngày thu <span class="req">{{$thucongtrinh->ngaythu}}</span></label>
                    <div class="formRight">
                 ...
                 <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><textarea class="form" rows="4" name = 'noidung' cols='60'>{{$thucongtrinh->noidung}}</textarea></span>
                     <span class="autocheck" name="name_autocheck"></span>
                 ...
                 <div class="formRow">
                    ...
                    <div class="formRight">
                     <img width='100'height='80' src='public/upload/thucongtrinh/{{$thucongtrinh->anh1}}'>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        ...
                        <img width='100'height='80' src='public/upload/thucongtrinh/{{$thucongtrinh->anh2}}'>
                        @endif
