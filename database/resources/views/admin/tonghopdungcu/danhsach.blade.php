...
<div class="wrapper" id="main_product">
    ...
    <div class="widget">
     <div class="title">
      <h3 style="margin-left: 170px;">DANH SÁCH CHI TIẾT CÁC DỤNG CỤ TẠI CÔNG TRÌNH -ĐƠN VỊ </h3>
       </div>
        </div>
                ...
                <form class="list_filter form" action="admin/tonghopdungcu/timkiem" method="get">
                    <table cellpadding="0" cellspacing="0" width="80%"><tbody>
                         ...
                         <tr>
                           ...
                           <td class="item"><label for="filter_id">Chọn dung cụ </label><select class="form-control"name ='madungcu'style="width:200px;"> 
                        ...
                        <input type="submit" class="button blueB" value="submit"style='width:120px' />
