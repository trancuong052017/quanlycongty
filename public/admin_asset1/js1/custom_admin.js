...
(function($)
{
	$(document).ready(function()
	{
		...
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn xóa tất cả dữ liệu phải không ?'))
			{
				return false;
			}
		...
		////////////// lay id de cap nhat lai san pham
		 
       var $list_action 	= $('.list_action_update');//tim toi the co class = list_action
		$list_action.find('#submit_up').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn cập nhật  tất cả dữ liệu phải không ? tất cả hàng tồn kho sẽ là hàng nhập'))
			{
				return false;
			}
...
/////////////////////////////////////////////////
       ...
       var $list_action 	= $('.list_action_email');//tim toi the co class = list_action
		$list_action.find('#submit_email').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn gửi mail cho toàn bộ khách hàng ?'))
			{
				return false;
			}
