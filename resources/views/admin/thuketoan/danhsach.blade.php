	 ...
	 @if(count($errors)>0)
	    ...
	    <div class='alert alert-danger'style="text-align: center color:red">
	     ...
	     <div class="title">
			...
			<h3 style="margin-left: 370px;">Bảng thu kế toán </h3>
			 
		</div>         
		<div class="title">
			<div class="num f12">
			<b>@if(isset($tongthu))Tổng thu toàn bộ các công trình-đơn vị : {{number_format($tongthu)}} vnd @endif </b></div>
			 <div class="num f12">
			<b>@if(isset($tongchi))Tổng chi: {{number_format($tongchi)}} vnd @endif </b></div>
			 <div class="num f12">
			<b>@if(isset($tongcon))Tổng còn: {{number_format($tongcon)}} vnd @endif</b> 
		    </div>
		</div>
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
			...
			<thead class="filter"><tr><td colspan="8">
				<form class="list_filter form" action="admin/thuketoan/timkiem" method="get">
					<table cellpadding="0" cellspacing="0" width="100%"><tbody>
					
						<tr>
							
							<td class="item"><label for="filter_id">Mã số</label><input name="id" value="" id="filter_id" type="text" style="width:55px;" /></td>
