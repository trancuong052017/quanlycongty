	    ...
	    <div class='alert alert-danger'style="text-align: center color:red">
	     ...
	     @endif 
	      <div class="title">
			...
			<h3 style="margin-left: 170px;">Bảng thu kế toán  Công trình - đơn vị:
...
<tbody class="list_item">
	...
	if(isset($denngay)){$denngay=$denngay;}else{$denngay='';}
	 ...
	 ?>
	 {{$thuketoan->appends(array('id'=>$id,'idcongtrinh'=>$idcongtrinh,'tungay'=>$tungay,'denngay'=>$denngay))->links()}}
</div>
</div>	
</div>
</div>	
