	 ...
	 @if(count($errors)>0)
	    ...
	    <div class='alert alert-danger'style="text-align: center color:red">
	     ...
	     <div class="title">
			...
			<h3 style="margin-left: 370px;">Bảng thu của công trình  </h3>
		...
		<div class="title">
           ...
           <div class="num f12">Tổng thu tiền mặt : <b> @if(isset($totall))
                      ...
                      @endforeach
                           ...
                           <td class="item">
                            ...
                            <td class="item"><label for="filter_status">Đến ngày </label>
                            	 <input name="dengay" value="" id="filter_iname" type="date" style="width:220px;" />
                            </td>
...
<tbody class="list_item">
	...
	<?php if(isset($idcongtrinh)){$idcongtrinh=$idcongtrinh;}else{$idcongtrinh='';}
	if(isset($tungay)){$tungay=$tungay;}else{$tungay='';}
	if(isset($denngay)){$denngay=$denngay;}else{$denngay='';}
	
	 ?>
	 {{$thucongtrinh->appends(array('idcongtrinh'=>$idcongtrinh,'tungay'=>$tungay,'denngay'=>$denngay ))->links()}}
</div>
</div>	
</div>
</div>	
